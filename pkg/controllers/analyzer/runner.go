...
import (
	...
	"github.com/ZupIT/horusec/pkg/services/formatters/c/flawfinder"
	dotnetcli "github.com/ZupIT/horusec/pkg/services/formatters/csharp/dotnet_cli"
	"github.com/ZupIT/horusec/pkg/services/formatters/csharp/horuseccsharp"
	"github.com/ZupIT/horusec/pkg/services/formatters/csharp/scs"
	"github.com/ZupIT/horusec/pkg/services/formatters/dart/horusecdart"
	"github.com/ZupIT/horusec/pkg/services/formatters/elixir/mixaudit"
	"github.com/ZupIT/horusec/pkg/services/formatters/elixir/sobelow"
	dependencycheck "github.com/ZupIT/horusec/pkg/services/formatters/generic/dependency_check"
	"github.com/ZupIT/horusec/pkg/services/formatters/generic/semgrep"
	"github.com/ZupIT/horusec/pkg/services/formatters/generic/trivy"
	"github.com/ZupIT/horusec/pkg/services/formatters/go/gosec"
	"github.com/ZupIT/horusec/pkg/services/formatters/go/nancy"
	"github.com/ZupIT/horusec/pkg/services/formatters/hcl/checkov"
	"github.com/ZupIT/horusec/pkg/services/formatters/hcl/tfsec"
	...
	"github.com/ZupIT/horusec/pkg/services/formatters/javascript/npmaudit"
	"github.com/ZupIT/horusec/pkg/services/formatters/javascript/yarnaudit"
	"github.com/ZupIT/horusec/pkg/services/formatters/kotlin/horuseckotlin"
	"github.com/ZupIT/horusec/pkg/services/formatters/leaks/gitleaks"
	...
	"github.com/ZupIT/horusec/pkg/services/formatters/php/phpcs"
	"github.com/ZupIT/horusec/pkg/services/formatters/python/bandit"
	"github.com/ZupIT/horusec/pkg/services/formatters/python/safety"
	"github.com/ZupIT/horusec/pkg/services/formatters/ruby/brakeman"
	"github.com/ZupIT/horusec/pkg/services/formatters/ruby/bundler"
	"github.com/ZupIT/horusec/pkg/services/formatters/shell/shellcheck"
